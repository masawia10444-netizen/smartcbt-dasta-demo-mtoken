...
type CommunityListWaitingForApproveProps = {
  communities?: Community[];
};

const CommunityListWaitingForApprove = ({ communities }: CommunityListWaitingForApproveProps) => {
  ...
  const columns = useMemo(
    () => [
      // TODO: Will update the key once the serialization is ready.
...
export default CommunityListWaitingForApprove;
