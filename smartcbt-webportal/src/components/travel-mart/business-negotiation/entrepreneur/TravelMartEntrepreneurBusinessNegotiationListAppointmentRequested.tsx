...
type TravelMartEntrepreneurBusinessNegotiationListAppointmentRequestedProps = {
  schedules: Schedule[];
};

const TravelMartEntrepreneurBusinessNegotiationListAppointmentRequested = ({
  schedules,
}: TravelMartEntrepreneurBusinessNegotiationListAppointmentRequestedProps) => {
...
export default TravelMartEntrepreneurBusinessNegotiationListAppointmentRequested;
